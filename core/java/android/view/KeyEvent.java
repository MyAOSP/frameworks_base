...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    /** Key code constant app switcher for old school
     * gingerbread recents. */
    public static final int KEYCODE_APP_SWITCH_GB   = 220;
    ...
    private static void populateKeycodeSymbolicNames() {
        ...
        names.append(KEYCODE_APP_SWITCH_GB, "KEYCODE_APP_SWITCH_GB");
    };
