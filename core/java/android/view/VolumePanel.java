...
public class VolumePanel extends Handler implements OnSeekBarChangeListener, View.OnClickListener
{
    ...
    public VolumePanel(final Context context, AudioService volumeService) {
        ...
        mVoiceCapable = mContext.getResources().getBoolean(R.bool.config_voice_capable);
        ...
        int choosenStyle = Settings.System.getInt(mContext.getContentResolver(),Settings.System.MODE_VOLUME_OVERLAY, -1);
