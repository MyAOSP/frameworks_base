...
public class BatteryMeterView extends View implements DemoMode {
    ...
    public BatteryMeterView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mBatteryTypeView.equals("statusbar") && mBatteryStyle == BATTERY_STYLE_HIDDEN) {
    ...
    public void updateSettings() {
        ...
        mPercentageChargingColor = Settings.System.getIntForUser(resolver,
                Settings.System.STATUS_BAR_BATTERY_TEXT_CHARGING_COLOR, -2, UserHandle.USER_CURRENT);
