    ...
    private static CharSequence makeCarierString(CharSequence plmn, CharSequence spn) {
     ...
     public void updateColors() {
        ...
        try {
            ...
            if (DEBUG) Log.d(TAG, String.format("Setting mWeatherCity DATE text color to %d", color));
        } catch (NullPointerException ne) {
            if (DEBUG) ne.printStackTrace();
        }
        ...
        try {
            ...
            if (DEBUG) Log.d(TAG, String.format("Setting mWeatherTemp DATE text color to %d", color));
        } catch (NullPointerException ne) {
            if (DEBUG) ne.printStackTrace();
        }
        ...
        try {
            ...
            if (DEBUG) Log.d(TAG, String.format("Setting mWeatherLowHigh DATE text color to %d", color));
        } catch (NullPointerException ne) {
            if (DEBUG) ne.printStackTrace();
        }
        ...
        try {
            ...
            if (DEBUG) Log.d(TAG, String.format("Setting mWeatherUpdateTime DATE text color to %d", color));
        } catch (NullPointerException ne) {
            if (DEBUG) ne.printStackTrace();
        }
        ...
        try {
            ...
            if (DEBUG) Log.d(TAG, String.format("Setting mWeatherCondition DATE text color to %d", color));
        } catch (NullPointerException ne) {
            if (DEBUG) ne.printStackTrace();
        }
        ...
        try {
            ...
            if (DEBUG) Log.d(TAG, String.format("Setting mCalendarEventTitle DATE text color to %d", color));
        } catch (NullPointerException ne) {
            if (DEBUG) ne.printStackTrace();
        }
        ...
        try {
            ...
            if (DEBUG) Log.d(TAG, String.format("Setting mCalendarEventDetails DATE text color to %d", color));
        } catch (NullPointerException ne) {
            if (DEBUG) ne.printStackTrace();
        }
        ...
        try {
            ...
            if (DEBUG) Log.d(TAG, String.format("Setting mEmergencyCallButton DATE text color to %d", color));
        } catch (NullPointerException ne) {
            if (DEBUG) ne.printStackTrace();
        }
